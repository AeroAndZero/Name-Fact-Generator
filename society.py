...
while True :
    ...
    else : print("Incorrect Gender Entered.")
...
str(name) + ", a fun energetic "+guygirl+", this "+guygirl+" just\noozes charisma.",
"A nice "+guygirl+",who respect the feelings of "+girlguy+"s,\ngood looking personality,charming,smart.",
...
str(name) + " is an amazing friend and "+heshe+" will always\nbe there for you.",
...
"You want to be like this "+guygirl+", "+heshe+"'s just too good\nto be true. A true legend.",
"keep "+himher+" in your life when "+heshe+" comes across\nyou. You might regret leaving "+himher+".",
...
girlguy+"s really dig a "+guygirl+" like "+himher+" cuz "+heshe+"'s got most\nof the skills..",
...
"Quite with the ones "+heshe+" is unfamiliar with, and\necstatic with those "+heshe+" prizes.",
...
heshe+" is dutiful and will never put "+hisher+" own thoughts\nand feelings before "+hisher+" loved ones.",
...
"If u r "+hisher+" "+girlguy+" he'll take care of u like a little\ndiamond of "+hisher+".",
...
hisher+" smile is infectious and "+heshe+" laughs all the\ntime which everyone loves about "+himher+".",
...
heshe+" thinks only about only the lucky "+girlguy+" "+heshe+" loves and\nno one else.",
...
"You are really lucky if you have a "+str(name)+" in your\nlife especially if you are dating her.",
...
heshe+" doesn't know how valuable "+heshe+" really is so\nmake "+himher+" realise "+hisher+" worth.",
...
str(name)+"'s are the model type, loved by "+girlguy+", and\nhated by some "+guygirl+"s who are jealous.",
...
str(name)+" is a "+guygirl+" who is not really insecure and is\nquite protective sometimes.",
...
for i in range(6):
    ...
    try:
        ...
        for j, line in enumerate(text.split('\n')):
            y0 += dy
            ImageDraw.Draw(image).text((70,y0),line,fill='rgb(0,0,0)',font=lines_font)
...
ImageDraw.Draw(image).text((1000-400,1000-30),'Python Script Made By @aero.n.zero',fill='rgb(0,0,0)',font=watermark_font)
